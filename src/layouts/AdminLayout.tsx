...
import {
  ...
  Ticket, DoorOpen, Sparkles, Mail, CheckSquare, Settings, Menu, Sun, HelpCircle, MapPin, BadgePercent, MessageCircle, Image,
} from "lucide-react";
...
const navItems = [
  ...
  { title: "Фотографии", path: "/admin/photos", icon: Image },
